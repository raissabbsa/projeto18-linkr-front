...
import { Column, PostContainer, Content, tagStyle, Top, LinkContainer, LinkInfo, mentionStyle, Form } from "../../assets/SinglePostStyle";
...
export default function SinglePost({ post, update, setUpdate }) {
  ...
  function sendEdition(e) {
    ...
    // console.log(oldHashtags, newHashtags);
